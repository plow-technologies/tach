...
insertTVSimpleTransform :: TransformKey -> TransformedInformation -> Update TVSimpleTransformStore (Either ErrorValue SuccessValue)
...
insertManyTVSimpleTransform :: TransformKey -> (S.Set TransformedInformation) -> Update TVSimpleTransformStore (Either ErrorValue SuccessValue)
